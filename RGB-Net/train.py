...
def main():
    # Hyperparameters
    # train_low = '/root/autodl-tmp/LOLv2/Synthetic/Train/Low'
    # train_high = '/root/autodl-tmp/LOLv2/Synthetic/Train/Normal'
    # test_low = '/root/autodl-tmp/LOLv2/Synthetic/Test/Low'
    # test_high = '/root/autodl-tmp/LOLv2/Synthetic/Test/Normal'

    # train_low = '/root/autodl-tmp/LOLv2/Real_captured/Train/Low'
    # train_high = '/root/autodl-tmp/LOLv2/Real_captured/Train/Normal'
    # test_low = '/root/autodl-tmp/LOLv2/Real_captured/Test/Low'
    # test_high = '/root/autodl-tmp/LOLv2/Real_captured/Test/Normal'

    train_low = '/root/autodl-tmp/LOLv1/Train/input'
    train_high = '/root/autodl-tmp/LOLv1/Train/target'
    test_low = '/root/autodl-tmp/LOLv1/Test/input'
    test_high = '/root/autodl-tmp/LOLv1/Test/target'

    # train_low = '/root/autodl-tmp/five/train/input'
    # train_high = '/root/autodl-tmp/five/train/gt'
    # test_low = '/root/autodl-tmp/five/test/input'
    # test_high = '/root/autodl-tmp/five/test/gt'

    # train_low = '/root/autodl-tmp/SICE/train/low'
    # train_high = '/root/autodl-tmp/SICE/train/gt'
    # test_low = '/root/autodl-tmp/SICE/test/low'
    # test_high = '/root/autodl-tmp/SICE/test/gt'

    # train_low = '/root/autodl-tmp/SICE/train/over'
    # train_high = '/root/autodl-tmp/SICE/train/gt'
    # test_low = '/root/autodl-tmp/SICE/test/over'
    # test_high = '/root/autodl-tmp/SICE/test/gt'
